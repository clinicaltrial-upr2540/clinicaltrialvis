...
AS 
 ...
 SELECT DISTINCT drug.primary_key AS drug_id,
    ...
    COALESCE("substring"(lower(drug.absorption), 'oral bioavailability [a-z. (0-9]+ [0-9.]+%'::text), "substring"(lower(drug.absorption), 'bioavailability [a-z. (-]+ [0-9.]+%'::text), "substring"(lower(drug.absorption), 'bioavailability .+ [0-9.]+%'::text)) AS bioavailability_phrase,
    "substring"("substring"(COALESCE("substring"(lower(drug.absorption), 'oral bioavailability [a-z. (0-9]+ [0-9.]+%'::text), "substring"(lower(drug.absorption), 'bioavailability [a-z. (-]+ [0-9.]+%'::text), "substring"(lower(drug.absorption), 'bioavailability .+ [0-9.]+%'::text)), '[0-9.]+%'::text), '[0-9.]+'::text) AS bioavailability_percent,
